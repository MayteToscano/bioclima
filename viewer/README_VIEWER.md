...
V7 update:
- Popup field names are ontology links too: Coverage, Parameter, Value, Cell, Coordinates, Definition, Ontology type, Unit and Semantic URI.
- Includes `data/ontology-index.json` with the additional viewer-field definitions.
- Upload the viewer files to `viewer/` and replace `data/ontology-index.json` with the included data file.
