...
function updateSemanticPanel(parameterId) {
  ...
  if (uri) {
    els.semanticTitle.innerHTML = `<a href="${escapeHtml(localOntologyHref(uri))}" target="_blank" rel="noopener">${escapeHtml(title)}</a>`;
    els.semanticLink.href = localOntologyHref(uri);
    els.semanticLink.textContent = t("openOntology");
    els.semanticLink.title = uri;
      ...
      <table class="popup-table">
        ...
        <tr>
          ...
          <td>
            ${
              uri
                ? `<a class="ontology-link" href="${escapeHtml(localOntologyHref(uri))}" target="_blank" rel="noopener">${escapeHtml(label)}</a>`
                : escapeHtml(label)
            }
          </td>
        </tr>
          ...
          uri
            ? `
              <tr>
                ...
                <td>
                  <a class="ontology-link" href="${escapeHtml(localOntologyHref(uri))}" target="_blank" rel="noopener">
                    ${escapeHtml(t("openOntology"))}
                  </a>
                  <span class="raw-uri">${escapeHtml(uri)}</span>
                </td>
              </tr>
            `
            : ""
