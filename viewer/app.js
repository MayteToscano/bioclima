...
function resolveUrlCandidates(url) {
  ...
  // The package includes a complete copy of data inside viewer/data.
  // Try this first, because it works even if the Pages workflow does not publish /data at root.
          ...
          semantic.uri
            ? `
              <tr>
                ...
                <td>
                  <a
                    class="raw-uri raw-uri-link"
                    href="${escapeHtml(localOntologyHref(semantic.uri))}"
                    target="_blank"
                    rel="noopener"
                    title="${escapeHtml(semantic.uri)}"
                  >
                    ${escapeHtml(semantic.uri)}
                  </a>
                </td>
              </tr>
            `
